...
<div class="wrap">	
	<div class="main">
				...
				<div class="ser-main">
				<div class="contact">				
						<h2 class="style top"><font face="微软雅黑">我的收藏</font></h2>
						<!-- start grids_of_3 -->
						<c:if test="${obj.row1 == '[]' }">
							<br />
							<br />
							<center>
							<font color="" face="微软雅黑">您还没有收藏任何信息！</font><br />
							<font color="" face="微软雅黑">去 <a href="${txFront }/publishForm?userId=${sessionScope.user.id }">收藏</a> 一条信息把！</font>
							</center>
						</c:if>
...
<script type="text/javascript">
		...
		jQuery(document).ready(function($) {
		     ...
		     * 动态设置分页页码
		     */
		     var url = "${txFront }/myCollection?pageNumber="
