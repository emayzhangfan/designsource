...
<div class="wrap">	
	<div class="main">
				...
				<div class="contact-form">
					<h2><font face="微软雅黑">编辑信息</font></h2>
					<br />
					<form id="validForm" method="post" action="${txFront }/editPublishSave"
			 	 	    	target="_self" enctype="multipart/form-data">
			 	 	    	<input name="id" type="hidden" class="textbox" value="${obj.id }">
			 	 	    	<input name="userId" type="hidden" class="textbox" value="${obj.userId }">
					    	<div class="contact-form-div">
						    	<span><label>物品名称<font color="#FA8072">*   </font></label></span>
						    	<span><input name="name" type="text" class="textbox required" value="${obj.name }"></span>
						    </div>
						    <div class="contact-form-div">
						    	<span><label>分类<font color="#FA8072">*   </font></label></span>
						    	<span><input id="classification-name" name="classificationName" readonly="true" type="text" class="textbox required" placeholder="分类选择" value="${obj.classificationName }"></span>
						    	<input id="classification-id" type="hidden" class="" name="classificationId" value="${obj.classificationId }">
						    </div>
						    <div class="contact-form-div">
						    	<span><label>发布标题<font color="#FA8072">*   </font></label></span>
						    	<span><input name="title" type="text" class="textbox required" value="${obj.title }"></span>
						    </div>
						    <div class="contact-form-div">
						    	<span><label>参考价格（单位：元）<font color="#FA8072">*   </font></label></span>
						    	<span><input name="price" type="text" class="textbox required" value="${obj.price }"></span>
						    </div>
			 	 			<br />
						    <div class="contact-form-div">
						    	<span><label>修改上传封面图片<font color="#FA8072">   图片大小不超过100K，推荐像素 380px * 366px</font></label></span>
						    	<span>
						    		<a class="btn_addPic" href="#" style="text-decoration: none; color:#999999;">
										<span><em></em>添加图片</span> 
										<input id="upload-goodsimg-show" class="filePrew" title="" tabIndex="3" type="file" size="3" name="showImg">
									</a>
						    	</span>
						   ...
						   <div class="contact-form-div">
						   		<span><input id="btn-publish-save" type="submit" class="" value="保存"></span>
						  </div>
			 	 	</form>
				</div>
  				<div class="clear"></div>		
...
<script type="text/javascript">
	...
	function onExpand(event, treeId, treeNode) {
		...
		jQuery(document).ready(function($) {
			...
			$('#summernote').summernote('code', '${obj.descriptions }');
