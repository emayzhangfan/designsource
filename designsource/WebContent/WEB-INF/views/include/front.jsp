...
<c:set var="txGoods" value="${pageContext.request.contextPath }/upload/images/show/"/>


<link rel="shortcut icon" href="${txStatic }/favicon-logo.ico">
...
<script type="text/javascript" src="${txStatic }/js/jquery.metadata.js"></script>
