...
<body>
		<div class="container">
			<h2 class="page-header"><font face="微软雅黑">已发布信息</font>  <small><code>&lt; GoodsInfo  &gt;</code></small></h2>
			
			
			<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" action="${txAdmin }/goods/record" method="post">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a data-confirm="确认将商品 ${data.name } 标记为垃圾吗？" 
						       class="btn btn-warning btn-xs" 
						       href="${txAdmin }/goods/setRubbish?id=${data.id }&pageNumber=${obj.qr.pager.pageNumber }&name=${obj.goods.name }&title=${obj.goods.title }&classificationId=${obj.goods.classificationId }&classificationName=${obj.goods.classificationName }">
						    标记为垃圾信息</a>
